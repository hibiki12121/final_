\documentclass[12pt, a4j]{ujreport} % a4jでもOKっぽい
...
\input{chapter/chapter-3} % 
\input{chapter/chapter-4} % 機械学習
\input{chapter/chapter-5} % 検証？
\input{chapter/chapter-6} % 
\input{chapter/chapter-7-v2}
\input{chapter/chapter-8}
\input{chapter/chapter-reference}
\input{chapter/chapter-thx}
